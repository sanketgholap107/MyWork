  ...
  return (
    <div className="breadcrumbs">
      ...
      {pathnames.map((name, index) => {
        ...
        if (name == "discparticularOrCTRB_details") {
          name = "Disc Particularor CTRB details";
        }
       
        if (name == "LHBSchedulePreInspection") {
          name = "LHB Schedule Pre-Inspection";
        }
        if (name == "Rodgaugeandsound_details") {
          name = "Rod Gauge and Sound Details";
        }
