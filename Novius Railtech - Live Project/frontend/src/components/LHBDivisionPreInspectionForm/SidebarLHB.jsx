...
// import "../../resources/LHB/lhbdivisionInspectionform/lhbdivisionInspectionform.css";
...
function SidebarLHB() {
  ...
  const handleLinkClick = (link) => {
    setActiveLink("/LHBDivisionPreInspectionForm/" +link);
  };
          ...
          {SidebarData.map((val, key) => {
            return (
              <li
                ...
                className={
                  activeLink === "/LHBDivisionPreInspectionForm/" + val.link
                    ? "active"
                    : "inactive"
                }
              >
